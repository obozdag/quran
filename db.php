...
//Get Suras
$sql_sura     = "SELECT * FROM fkl_sura";
$result_sura  = mysqli_query($conn, $sql_sura);
$rows_sura    = mysqli_fetch_all($result_sura, MYSQLI_ASSOC);

//Get Verses of the Sura
$sql_verse    = "SELECT v.*, s.name AS sura_name, s.tr AS sura_tr, s.en AS sura_en, s.basmala, s.verses, s.sajdah AS sura_sajdah FROM fkl_verse v INNER JOIN fkl_sura s ON s.id = v.sura_id";
